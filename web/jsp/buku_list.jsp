...
<script language="javascript" type="text/javascript" src="<html:rewrite page="/js/Ajax.js"/>"></script><!--buat AJAX-->
    ...
    <h3><html:errors/></h3>
				...
				<logic:present name="bukuList" scope="request">
					...
					<logic:iterate id="buku" name="bukuList"  type="com.ams.model.Buku" scope="request">	
						<tr>
							...
							<td align="center"><bean:write name="buku" property="kode" scope="page"/></td>						
		...
		<center>
			...
			<input class = "button" type="button"  onclick="window.location.href=('<html:rewrite page="/buku/form.do"/>');" value=<bean:message key ="page.tambahBuku.title" />">
		</center>
		<tr>
			<td>
				<center>
