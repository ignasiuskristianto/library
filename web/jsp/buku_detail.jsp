...
<body bgcolor="#D3D3D3">
<h1><bean:message key="page.detailBuku.title"/></h1>
<br/>
		...
		<html:form action="buku/detail">
    		...
    		<table width="100%" border="1" cellspacing="0" cellpadding="0">
				...
				<tr>
						<td align="center"><bean:write name="buku" property="judul" scope="request"/></td>						
						<td align="center"><bean:write name="buku" property="kode" scope="request"/></td>
						<td align="center"><bean:write name="buku" property="kategori.nama" scope="request"/></td>
						<td align="center"><bean:write name="buku" property="jumlah" scope="request"/></td>
