...
<script language="javascript" type="text/javascript" src="<html:rewrite page="/js/Ajax.js"/>"></script><!--buat AJAX-->
    ...
    <H3 align="center"><bean:message key="page.kategoriBukuList.title"/></H3>
    ...
    <h3><html:errors/></h3>
		...
		<html:form action = "/kategori/list">
		...
		<center>
          ...
          <table width="100%" border="1" cellspacing="0" cellpadding="0">
				...
				<logic:present name="kategoriBukuList" scope="request">
					...
					<logic:iterate id="kategoriBuku" name="kategoriBukuList"  type="com.ams.model.KategoriBuku" scope="request">	
				  <tr>
				  	<td align="center"><%=i%></td>						
						<td align="center"><bean:write name="kategoriBuku" property="nama" scope="page"/></td>
						
						<td align="center"><html:link action="/kategori/detail" paramId="id" paramName="kategoriBuku" paramProperty="id">detail</html:link></td>					
						<td align="center"><html:link action="/kategori/form" paramId="id" paramName="kategoriBuku" paramProperty="id">edit</html:link></td>
						<td align="center"><html:link action="/kategori/delete" paramId="id" paramName="kategoriBuku" paramProperty="id">delete</html:link></td>
					</tr>
					<% i++; %>
					</logic:iterate>
			    </logic:present> 
		...
		<center>
			...
			<input class = "button" type="button"  onclick="window.location.href=('<html:rewrite page="/kategori/form.do"/>');" value=<bean:message key ="page.tambahKategoriBuku.title" />">
		</center>
		<tr>
			<td>
				<center>
